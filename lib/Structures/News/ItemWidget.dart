...
class _ItemWidgetState extends State<ItemWidget> {
  ...
  var versions = [
    ...
    NewVersion(version: "0.0.6", features: [
      ...
      FeatureDescriber(
        "Контрагенты",
        "Добавлена возможность создания контакта из карточки контрагента",
      ),
      FeatureDescriber(
        "Взаиморасчеты",
        "Теперь в карточке контрагента можно посмотреть текущую ситуацию по взаиморасчетам с контрагентом",
      ),
    ], bugs: [
      FeatureDescriber(
    ...
    NewVersion(version: "0.0.4", features: [
      ...
      FeatureDescriber("Получатели сообщения",
          "Теперь при выборе получателей в сообщении можно долгим нажатием на группу открыть меню и отметить сотрудников списка. В этом случае отметя��ся сотрудники группы, а не группа вцелом. Так можно исключить сотрудников из получателей"),
