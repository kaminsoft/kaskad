        ...
        Padding(
          ...
          child: Row(
            ...
            Expanded(
                child: FlatButton(
                  onPressed: () {
                    Data.analytics.logEvent(name: 'feature_vote',parameters: {'name': feature});
                    Navigator.of(context).pop();
                     Toast.show('Спасибо, Ваш голос учтен!', context,backgroundColor: ColorMain, gravity: Toast.TOP, duration: 5);
                  },
                  color: ColorMain,
                  highlightColor: ColorMain,
                  splashColor: ColorMain,
                  child: Text("Хочу!", style: TextStyle(color: Colors.white),),
                ),
              ),
            ],
          ),
